...
const char* erts_build_flags_CFLAGS = "-Werror=return-type  -g -O2 -I/buildroot/otp_src_17.0/erts/x86_64-unknown-linux-gnu   -fno-tree-copyrename  -D_GNU_SOURCE  -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  ";
...
#define ERTS_EMU_CMDLINE_FLAGS \" -g -O2 -I/buildroot/otp_src_17.0/erts/x86_64-unknown-linux-gnu   -fno-tree-copyrename  -D_GNU_SOURCE -g  -D_GNU_SOURCE -I/buildroot/otp_src_17.0/erts/x86_64-unknown-linux-gnu     -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  -Werror=return-type  -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement\"\n\
\n\
...
#define HAVE_LIBM 1\n\
\n\
/* Define to 1 if you have the `systemd-daemon' library (-lsystemd-daemon). */\n\
/* #undef HAVE_LIBSYSTEMD_DAEMON */\n\
\n\
