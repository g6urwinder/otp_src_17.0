 ...
 *       'make_alloc_types' on Fri Dec  8 09:39:34 2017.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (58)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (59)
#define ERTS_ALC_N_MAX_A_STANDARD (93)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (94)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (133)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (134)
#define ERTS_ALC_N_MAX_A_EHEAP (137)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (138)
#define ERTS_ALC_N_MAX_A_ETS (146)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (147)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (152)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (153)
#define ERTS_ALC_N_MAX_A_BINARY (154)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (155)
#define ERTS_ALC_N_MAX_A_DRIVER (172)

#define ERTS_ALC_N_MAX (172)
...
#define ERTS_ALC_T_POLLSET_UPDREQ (7507)
#define ERTS_ALC_T_REG_PROC (7572)
#define ERTS_ALC_T_LINK_LH (7700)
#define ERTS_ALC_T_SUSPEND_MON (7828)
#define ERTS_ALC_T_LL_BIF_TIMER (7956)
#define ERTS_ALC_T_REG_TABLE (8148)
#define ERTS_ALC_T_FUN_TABLE (8292)
#define ERTS_ALC_T_DIST_TABLE (8404)
#define ERTS_ALC_T_NODE_TABLE (8532)
#define ERTS_ALC_T_MODULE_REFS (8676)
#define ERTS_ALC_T_DCACHE (8788)
#define ERTS_ALC_T_DIST_ENTRY (8916)
#define ERTS_ALC_T_NODE_ENTRY (9044)
#define ERTS_ALC_T_ARG_REG (9108)
#define ERTS_ALC_T_PROC_DICT (9236)
#define ERTS_ALC_T_CALLS_BUF (9364)
#define ERTS_ALC_T_BPD (9556)
#define ERTS_ALC_T_LINEBUF (9684)
#define ERTS_ALC_T_IOQ (9812)
#define ERTS_ALC_T_BITS_BUF (9940)
#define ERTS_ALC_T_DB_NTAB_ENT (10020)
#define ERTS_ALC_T_DDLL_HANDLE (10196)
...
#define ERTS_ALC_T_PORT_DATA_HEAP (10964)
...
#define ERTS_ALC_T_FD_ENTRY_BUF (11860)
#define ERTS_ALC_T_PRT_REP_EXIT (11988)
#define ERTS_ALC_T_ATOM (12101)
#define ERTS_ALC_T_MODULE (12261)
#define ERTS_ALC_T_FUN_ENTRY (12389)
#define ERTS_ALC_T_ATOM_TXT (12485)
#define ERTS_ALC_T_BIF_TIMER_TABLE (12629)
#define ERTS_ALC_T_ATOM_TABLE (12741)
#define ERTS_ALC_T_EXPORT_TABLE (12901)
#define ERTS_ALC_T_MODULE_TABLE (13029)
#define ERTS_ALC_T_TAINT (13157)
#define ERTS_ALC_T_PROC_TABLE (13205)
#define ERTS_ALC_T_PORT_TABLE (13397)
#define ERTS_ALC_T_TIMER_WHEEL (13525)
#define ERTS_ALC_T_ASYNC_DATA (13653)
#define ERTS_ALC_T_DB_TABLES (13733)
#define ERTS_ALC_T_INSTR_INFO (13909)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (14037)
#define ERTS_ALC_T_RUNQS (14165)
#define ERTS_ALC_T_DDLL_ERRCODES (14293)
#define ERTS_ALC_T_PRE_ALLOC_DATA (14421)
#define ERTS_ALC_T_CPUDATA (14549)
#define ERTS_ALC_T_CPU_GRPS_MAP (14677)
#define ERTS_ALC_T_AUX_WORK_TMO (14805)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (14933)
#define ERTS_ALC_T_PROC_INTERVAL (15061)
#define ERTS_ALC_T_THR_Q_LL (15189)
#define ERTS_ALC_T_ETHR_LL (15317)
#define ERTS_ALC_T_CODE (15461)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (15525)
#define ERTS_ALC_T_SCHDLR_DATA (15701)
#define ERTS_ALC_T_LL_TEMP_TERM (15829)
#define ERTS_ALC_T_EXPORT (15973)
#define ERTS_ALC_T_DRV_TAB (16085)
#define ERTS_ALC_T_DRV_EV_STATE (16213)
#define ERTS_ALC_T_POLLSET (16341)
#define ERTS_ALC_T_POLL_FDS (16469)
#define ERTS_ALC_T_POLL_RES_EVS (16597)
#define ERTS_ALC_T_FD_STATUS (16725)
#define ERTS_ALC_T_SELECT_FDS (16853)
#define ERTS_ALC_T_FD_TAB (16981)
#define ERTS_ALC_T_CS_PROG_PATH (17109)
#define ERTS_ALC_T_BEAM_REGISTER (17174)
#define ERTS_ALC_T_HEAP (17302)
#define ERTS_ALC_T_OLD_HEAP (17430)
#define ERTS_ALC_T_HEAP_FRAG (17558)
#define ERTS_ALC_T_DB_TABLE (17703)
#define ERTS_ALC_T_DB_SEG (17831)
#define ERTS_ALC_T_DB_SEG_TAB (17959)
#define ERTS_ALC_T_DB_STK (18087)
#define ERTS_ALC_T_DB_TRANS_TAB (18215)
#define ERTS_ALC_T_DB_SEL_LIST (18343)
#define ERTS_ALC_T_DB_DMC_ERROR (18471)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (18599)
#define ERTS_ALC_T_DB_TERM (18727)
#define ERTS_ALC_T_PROC (18840)
#define ERTS_ALC_T_MSG_REF (18968)
#define ERTS_ALC_T_MONITOR_SH (19096)
#define ERTS_ALC_T_NLINK_SH (19224)
#define ERTS_ALC_T_DRV_EV_D_STATE (19416)
#define ERTS_ALC_T_DRV_SEL_D_STATE (19544)
#define ERTS_ALC_T_DRV_BINARY (19641)
#define ERTS_ALC_T_BINARY (19769)
#define ERTS_ALC_T_PORT (19930)
#define ERTS_ALC_T_DRV (20058)
#define ERTS_ALC_T_DRIVER (20186)
#define ERTS_ALC_T_DRV_CMD_DATA (20314)
#define ERTS_ALC_T_DRV_CTRL_DATA (20442)
#define ERTS_ALC_T_DRV_CALL_DATA (20570)
#define ERTS_ALC_T_NIF (20698)
#define ERTS_ALC_T_PORT_DATA_LOCK (20826)
#define ERTS_ALC_T_DRV_THR_OPTS (20954)
#define ERTS_ALC_T_DRV_TID (21082)
#define ERTS_ALC_T_DRV_MTX (21210)
#define ERTS_ALC_T_DRV_CND (21338)
#define ERTS_ALC_T_DRV_RWLCK (21466)
#define ERTS_ALC_T_DRV_TSD (21594)
#define ERTS_ALC_T_THR_Q_EL (21722)
#define ERTS_ALC_T_THR_Q_EL_SL (21850)
#define ERTS_ALC_T_MISC_AUX_WORK (21978)
#define ERTS_ALC_T_ASYNC (22106)
